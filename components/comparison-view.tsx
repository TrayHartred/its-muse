      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="bg-[#111113]/90 backdrop-blur-sm border border-[#1F1F23] rounded-xl p-4 sm:p-5">
          <div className="flex items-center gap-2 mb-3 pb-2.5 border-b border-[#1F1F23]">
            ...
            <span className="text-[13px] font-medium tracking-wide text-[#52525B] uppercase">Original</span>
          </div>
        ...
        <div className="bg-[#111113]/90 backdrop-blur-sm border border-[#22C55E]/20 rounded-xl p-4 sm:p-5">
          ...
          <button
            onClick={onCopy}
            className="sm:hidden mt-4 w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-[#22C55E]/10 hover:bg-[#22C55E]/15 border border-[#22C55E]/25 text-[#22C55E] font-medium rounded-lg text-[15px] transition-colors"
          >
