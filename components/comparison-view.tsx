  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-[#111113]/90 backdrop-blur-sm border border-[#1F1F23] rounded-xl px-4 py-3">
        ...
        <button
          onClick={onCopy}
          className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-[#22C55E]/10 hover:bg-[#22C55E]/20 border border-[#22C55E]/30 text-[#22C55E] font-medium rounded-lg text-[13px] transition-colors"
        >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="bg-[#111113]/90 backdrop-blur-sm border border-[#1F1F23] rounded-xl p-4 sm:p-5">
          <div className="flex items-center gap-2 mb-3 pb-2.5 border-b border-[#1F1F23]">
            ...
            <span className="text-[11px] font-medium tracking-wide text-[#52525B] uppercase">Original</span>
          </div>
          <div className="text-[14px] text-[#A1A1AA] leading-[1.7]">
            <HighlightedText
              text={originalText}
              tactics={tactics}
        ...
        <div className="bg-[#111113]/90 backdrop-blur-sm border border-[#22C55E]/20 rounded-xl p-4 sm:p-5">
          <div className="flex items-center justify-between mb-3 pb-2.5 border-b border-[#1F1F23]">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-medium tracking-wide text-[#22C55E] uppercase">Clean version</span>
            </div>
            <button
              onClick={onRegenerate}
              disabled={isRegenerating}
              className="flex items-center gap-1.5 px-2 py-1 bg-[#1A1A1D] hover:bg-[#2A2A2E] border border-[#27272A] rounded-md text-[#A1A1AA] text-[11px] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <p className="text-[14px] text-[#E4E4E7] leading-[1.7] font-mono whitespace-pre-wrap">
            {cleanText}
            {isRegenerating && (
          ...
          <button
            onClick={onCopy}
            className="sm:hidden mt-4 w-full flex items-center justify-center gap-2 px-3 py-2.5 bg-[#22C55E]/10 hover:bg-[#22C55E]/15 border border-[#22C55E]/25 text-[#22C55E] font-medium rounded-lg text-[13px] transition-colors"
          >
